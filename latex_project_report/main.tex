...
Then we modified our circuit into an active bandpass filter circuit by calculating the necessary values as shown in 4.2.1. Next using the signal generator, we observed the characteristics of our filter circuit from the digital oscilloscope. The responses were as follows:

\begin{figure}[!htbp]
	
	\begin{tabular}{ccc}

\subfloat[something]{\includegraphics[width = 1.5in]{1.jpg}}&
\subfloat[something]{\includegraphics[width = 1.5in]{22.jpg}}&
\subfloat[something]{\includegraphics[width = 1.5in]{test2.jpg}}\\
